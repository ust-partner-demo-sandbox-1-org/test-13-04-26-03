...
interface Entity920Repository : org.springframework.data.jpa.repository.JpaRepository<Entity920, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity920>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity920>
}
...
class Service920(private val repo: Entity920Repository) {
    ...
    fun findActive(): List<Entity920> = repo.findByField4(true)
    fun search(query: String): List<Entity920> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity920>): Map<String, List<Entity920>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity920): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity920")
class Controller920(private val service: Service920) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity920) = service.save(entity)
    @DeleteMapping("/{id}")
