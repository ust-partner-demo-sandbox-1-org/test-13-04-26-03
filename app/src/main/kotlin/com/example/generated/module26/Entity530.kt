...
interface Entity530Repository : org.springframework.data.jpa.repository.JpaRepository<Entity530, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity530>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity530>
}
...
class Service530(private val repo: Entity530Repository) {
    ...
    fun findActive(): List<Entity530> = repo.findByField4(true)
    fun search(query: String): List<Entity530> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity530>): Map<String, List<Entity530>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity530): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity530")
class Controller530(private val service: Service530) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity530) = service.save(entity)
    @DeleteMapping("/{id}")
