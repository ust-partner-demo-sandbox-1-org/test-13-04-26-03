...
interface Entity211Repository : org.springframework.data.jpa.repository.JpaRepository<Entity211, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity211>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity211>
}
...
class Service211(private val repo: Entity211Repository) {
    ...
    fun findActive(): List<Entity211> = repo.findByField4(true)
    fun search(query: String): List<Entity211> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity211>): Map<String, List<Entity211>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity211): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity211")
class Controller211(private val service: Service211) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity211) = service.save(entity)
    @DeleteMapping("/{id}")
