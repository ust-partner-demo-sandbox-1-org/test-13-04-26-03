...
interface Entity200Repository : org.springframework.data.jpa.repository.JpaRepository<Entity200, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity200>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity200>
}
...
class Service200(private val repo: Entity200Repository) {
    ...
    fun findActive(): List<Entity200> = repo.findByField4(true)
    fun search(query: String): List<Entity200> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity200>): Map<String, List<Entity200>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity200): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity200")
class Controller200(private val service: Service200) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity200) = service.save(entity)
    @DeleteMapping("/{id}")
