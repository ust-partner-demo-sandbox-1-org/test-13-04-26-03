...
interface Entity615Repository : org.springframework.data.jpa.repository.JpaRepository<Entity615, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity615>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity615>
}
...
class Service615(private val repo: Entity615Repository) {
    ...
    fun findActive(): List<Entity615> = repo.findByField4(true)
    fun search(query: String): List<Entity615> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity615>): Map<String, List<Entity615>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity615): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity615")
class Controller615(private val service: Service615) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity615) = service.save(entity)
    @DeleteMapping("/{id}")
