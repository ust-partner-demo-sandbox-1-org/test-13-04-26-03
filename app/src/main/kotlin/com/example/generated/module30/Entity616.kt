...
interface Entity616Repository : org.springframework.data.jpa.repository.JpaRepository<Entity616, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity616>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity616>
}
...
class Service616(private val repo: Entity616Repository) {
    ...
    fun findActive(): List<Entity616> = repo.findByField4(true)
    fun search(query: String): List<Entity616> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity616>): Map<String, List<Entity616>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity616): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity616")
class Controller616(private val service: Service616) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity616) = service.save(entity)
    @DeleteMapping("/{id}")
