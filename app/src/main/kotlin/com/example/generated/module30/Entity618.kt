...
interface Entity618Repository : org.springframework.data.jpa.repository.JpaRepository<Entity618, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity618>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity618>
}
...
class Service618(private val repo: Entity618Repository) {
    ...
    fun findActive(): List<Entity618> = repo.findByField4(true)
    fun search(query: String): List<Entity618> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity618>): Map<String, List<Entity618>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity618): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity618")
class Controller618(private val service: Service618) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity618) = service.save(entity)
    @DeleteMapping("/{id}")
