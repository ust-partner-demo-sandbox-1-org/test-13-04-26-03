...
interface Entity606Repository : org.springframework.data.jpa.repository.JpaRepository<Entity606, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity606>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity606>
}
...
class Service606(private val repo: Entity606Repository) {
    ...
    fun findActive(): List<Entity606> = repo.findByField4(true)
    fun search(query: String): List<Entity606> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity606>): Map<String, List<Entity606>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity606): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity606")
class Controller606(private val service: Service606) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity606) = service.save(entity)
    @DeleteMapping("/{id}")
