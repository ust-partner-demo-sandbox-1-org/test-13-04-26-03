...
interface Entity516Repository : org.springframework.data.jpa.repository.JpaRepository<Entity516, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity516>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity516>
}
...
class Service516(private val repo: Entity516Repository) {
    ...
    fun findActive(): List<Entity516> = repo.findByField4(true)
    fun search(query: String): List<Entity516> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity516>): Map<String, List<Entity516>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity516): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity516")
class Controller516(private val service: Service516) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity516) = service.save(entity)
    @DeleteMapping("/{id}")
