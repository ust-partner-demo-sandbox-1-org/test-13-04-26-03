...
interface Entity885Repository : org.springframework.data.jpa.repository.JpaRepository<Entity885, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity885>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity885>
}
...
class Service885(private val repo: Entity885Repository) {
    ...
    fun findActive(): List<Entity885> = repo.findByField4(true)
    fun search(query: String): List<Entity885> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity885>): Map<String, List<Entity885>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity885): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity885")
class Controller885(private val service: Service885) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity885) = service.save(entity)
    @DeleteMapping("/{id}")
