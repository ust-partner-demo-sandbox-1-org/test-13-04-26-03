...
interface Entity910Repository : org.springframework.data.jpa.repository.JpaRepository<Entity910, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity910>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity910>
}
...
class Service910(private val repo: Entity910Repository) {
    ...
    fun findActive(): List<Entity910> = repo.findByField4(true)
    fun search(query: String): List<Entity910> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity910>): Map<String, List<Entity910>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity910): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity910")
class Controller910(private val service: Service910) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity910) = service.save(entity)
    @DeleteMapping("/{id}")
