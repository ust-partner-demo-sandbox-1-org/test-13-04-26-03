...
interface Entity542Repository : org.springframework.data.jpa.repository.JpaRepository<Entity542, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity542>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity542>
}
...
class Service542(private val repo: Entity542Repository) {
    ...
    fun findActive(): List<Entity542> = repo.findByField4(true)
    fun search(query: String): List<Entity542> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity542>): Map<String, List<Entity542>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity542): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity542")
class Controller542(private val service: Service542) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity542) = service.save(entity)
    @DeleteMapping("/{id}")
