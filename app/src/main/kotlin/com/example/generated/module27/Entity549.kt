...
interface Entity549Repository : org.springframework.data.jpa.repository.JpaRepository<Entity549, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity549>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity549>
}
...
class Service549(private val repo: Entity549Repository) {
    ...
    fun findActive(): List<Entity549> = repo.findByField4(true)
    fun search(query: String): List<Entity549> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity549>): Map<String, List<Entity549>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity549): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity549")
class Controller549(private val service: Service549) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity549) = service.save(entity)
    @DeleteMapping("/{id}")
