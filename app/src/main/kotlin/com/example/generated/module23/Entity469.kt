...
interface Entity469Repository : org.springframework.data.jpa.repository.JpaRepository<Entity469, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity469>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity469>
}
...
class Service469(private val repo: Entity469Repository) {
    ...
    fun findActive(): List<Entity469> = repo.findByField4(true)
    fun search(query: String): List<Entity469> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity469>): Map<String, List<Entity469>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity469): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity469")
class Controller469(private val service: Service469) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity469) = service.save(entity)
    @DeleteMapping("/{id}")
