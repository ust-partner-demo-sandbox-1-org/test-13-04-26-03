...
interface Entity461Repository : org.springframework.data.jpa.repository.JpaRepository<Entity461, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity461>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity461>
}
...
class Service461(private val repo: Entity461Repository) {
    ...
    fun findActive(): List<Entity461> = repo.findByField4(true)
    fun search(query: String): List<Entity461> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity461>): Map<String, List<Entity461>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity461): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity461")
class Controller461(private val service: Service461) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity461) = service.save(entity)
    @DeleteMapping("/{id}")
