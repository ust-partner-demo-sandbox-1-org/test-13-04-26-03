...
interface Entity462Repository : org.springframework.data.jpa.repository.JpaRepository<Entity462, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity462>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity462>
}
...
class Service462(private val repo: Entity462Repository) {
    ...
    fun findActive(): List<Entity462> = repo.findByField4(true)
    fun search(query: String): List<Entity462> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity462>): Map<String, List<Entity462>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity462): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity462")
class Controller462(private val service: Service462) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity462) = service.save(entity)
    @DeleteMapping("/{id}")
