...
interface Entity269Repository : org.springframework.data.jpa.repository.JpaRepository<Entity269, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity269>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity269>
}
...
class Service269(private val repo: Entity269Repository) {
    ...
    fun findActive(): List<Entity269> = repo.findByField4(true)
    fun search(query: String): List<Entity269> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity269>): Map<String, List<Entity269>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity269): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity269")
class Controller269(private val service: Service269) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity269) = service.save(entity)
    @DeleteMapping("/{id}")
