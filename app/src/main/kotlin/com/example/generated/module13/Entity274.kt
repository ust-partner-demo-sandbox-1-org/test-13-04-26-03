...
interface Entity274Repository : org.springframework.data.jpa.repository.JpaRepository<Entity274, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity274>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity274>
}
...
class Service274(private val repo: Entity274Repository) {
    ...
    fun findActive(): List<Entity274> = repo.findByField4(true)
    fun search(query: String): List<Entity274> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity274>): Map<String, List<Entity274>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity274): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity274")
class Controller274(private val service: Service274) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity274) = service.save(entity)
    @DeleteMapping("/{id}")
