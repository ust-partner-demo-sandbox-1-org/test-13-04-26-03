...
interface Entity277Repository : org.springframework.data.jpa.repository.JpaRepository<Entity277, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity277>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity277>
}
...
class Service277(private val repo: Entity277Repository) {
    ...
    fun findActive(): List<Entity277> = repo.findByField4(true)
    fun search(query: String): List<Entity277> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity277>): Map<String, List<Entity277>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity277): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity277")
class Controller277(private val service: Service277) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity277) = service.save(entity)
    @DeleteMapping("/{id}")
