...
interface Entity267Repository : org.springframework.data.jpa.repository.JpaRepository<Entity267, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity267>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity267>
}
...
class Service267(private val repo: Entity267Repository) {
    ...
    fun findActive(): List<Entity267> = repo.findByField4(true)
    fun search(query: String): List<Entity267> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity267>): Map<String, List<Entity267>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity267): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity267")
class Controller267(private val service: Service267) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity267) = service.save(entity)
    @DeleteMapping("/{id}")
