...
interface Entity276Repository : org.springframework.data.jpa.repository.JpaRepository<Entity276, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity276>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity276>
}
...
class Service276(private val repo: Entity276Repository) {
    ...
    fun findActive(): List<Entity276> = repo.findByField4(true)
    fun search(query: String): List<Entity276> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity276>): Map<String, List<Entity276>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity276): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity276")
class Controller276(private val service: Service276) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity276) = service.save(entity)
    @DeleteMapping("/{id}")
