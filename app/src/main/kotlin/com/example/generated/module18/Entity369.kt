...
interface Entity369Repository : org.springframework.data.jpa.repository.JpaRepository<Entity369, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity369>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity369>
}
...
class Service369(private val repo: Entity369Repository) {
    ...
    fun findActive(): List<Entity369> = repo.findByField4(true)
    fun search(query: String): List<Entity369> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity369>): Map<String, List<Entity369>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity369): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity369")
class Controller369(private val service: Service369) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity369) = service.save(entity)
    @DeleteMapping("/{id}")
