...
interface Entity133Repository : org.springframework.data.jpa.repository.JpaRepository<Entity133, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity133>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity133>
}
...
class Service133(private val repo: Entity133Repository) {
    ...
    fun findActive(): List<Entity133> = repo.findByField4(true)
    fun search(query: String): List<Entity133> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity133>): Map<String, List<Entity133>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity133): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity133")
class Controller133(private val service: Service133) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity133) = service.save(entity)
    @DeleteMapping("/{id}")
