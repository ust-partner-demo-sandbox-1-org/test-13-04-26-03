...
interface Entity660Repository : org.springframework.data.jpa.repository.JpaRepository<Entity660, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity660>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity660>
}
...
class Service660(private val repo: Entity660Repository) {
    ...
    fun findActive(): List<Entity660> = repo.findByField4(true)
    fun search(query: String): List<Entity660> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity660>): Map<String, List<Entity660>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity660): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity660")
class Controller660(private val service: Service660) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity660) = service.save(entity)
    @DeleteMapping("/{id}")
