...
interface Entity671Repository : org.springframework.data.jpa.repository.JpaRepository<Entity671, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity671>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity671>
}
...
class Service671(private val repo: Entity671Repository) {
    ...
    fun findActive(): List<Entity671> = repo.findByField4(true)
    fun search(query: String): List<Entity671> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity671>): Map<String, List<Entity671>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity671): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity671")
class Controller671(private val service: Service671) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity671) = service.save(entity)
    @DeleteMapping("/{id}")
