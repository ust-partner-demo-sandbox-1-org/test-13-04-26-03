...
interface Entity338Repository : org.springframework.data.jpa.repository.JpaRepository<Entity338, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity338>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity338>
}
...
class Service338(private val repo: Entity338Repository) {
    ...
    fun findActive(): List<Entity338> = repo.findByField4(true)
    fun search(query: String): List<Entity338> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity338>): Map<String, List<Entity338>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity338): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity338")
class Controller338(private val service: Service338) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity338) = service.save(entity)
    @DeleteMapping("/{id}")
