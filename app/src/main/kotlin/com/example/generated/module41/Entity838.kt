...
interface Entity838Repository : org.springframework.data.jpa.repository.JpaRepository<Entity838, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity838>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity838>
}
...
class Service838(private val repo: Entity838Repository) {
    ...
    fun findActive(): List<Entity838> = repo.findByField4(true)
    fun search(query: String): List<Entity838> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity838>): Map<String, List<Entity838>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity838): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity838")
class Controller838(private val service: Service838) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity838) = service.save(entity)
    @DeleteMapping("/{id}")
