...
interface Entity820Repository : org.springframework.data.jpa.repository.JpaRepository<Entity820, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity820>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity820>
}
...
class Service820(private val repo: Entity820Repository) {
    ...
    fun findActive(): List<Entity820> = repo.findByField4(true)
    fun search(query: String): List<Entity820> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity820>): Map<String, List<Entity820>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity820): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity820")
class Controller820(private val service: Service820) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity820) = service.save(entity)
    @DeleteMapping("/{id}")
