...
interface Entity835Repository : org.springframework.data.jpa.repository.JpaRepository<Entity835, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity835>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity835>
}
...
class Service835(private val repo: Entity835Repository) {
    ...
    fun findActive(): List<Entity835> = repo.findByField4(true)
    fun search(query: String): List<Entity835> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity835>): Map<String, List<Entity835>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity835): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity835")
class Controller835(private val service: Service835) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity835) = service.save(entity)
    @DeleteMapping("/{id}")
