...
interface Entity829Repository : org.springframework.data.jpa.repository.JpaRepository<Entity829, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity829>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity829>
}
...
class Service829(private val repo: Entity829Repository) {
    ...
    fun findActive(): List<Entity829> = repo.findByField4(true)
    fun search(query: String): List<Entity829> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity829>): Map<String, List<Entity829>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity829): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity829")
class Controller829(private val service: Service829) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity829) = service.save(entity)
    @DeleteMapping("/{id}")
