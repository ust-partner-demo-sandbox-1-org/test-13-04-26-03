...
interface Entity281Repository : org.springframework.data.jpa.repository.JpaRepository<Entity281, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity281>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity281>
}
...
class Service281(private val repo: Entity281Repository) {
    ...
    fun findActive(): List<Entity281> = repo.findByField4(true)
    fun search(query: String): List<Entity281> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity281>): Map<String, List<Entity281>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity281): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity281")
class Controller281(private val service: Service281) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity281) = service.save(entity)
    @DeleteMapping("/{id}")
