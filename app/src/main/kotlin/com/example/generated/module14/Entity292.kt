...
interface Entity292Repository : org.springframework.data.jpa.repository.JpaRepository<Entity292, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity292>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity292>
}
...
class Service292(private val repo: Entity292Repository) {
    ...
    fun findActive(): List<Entity292> = repo.findByField4(true)
    fun search(query: String): List<Entity292> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity292>): Map<String, List<Entity292>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity292): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity292")
class Controller292(private val service: Service292) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity292) = service.save(entity)
    @DeleteMapping("/{id}")
