...
interface Entity299Repository : org.springframework.data.jpa.repository.JpaRepository<Entity299, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity299>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity299>
}
...
class Service299(private val repo: Entity299Repository) {
    ...
    fun findActive(): List<Entity299> = repo.findByField4(true)
    fun search(query: String): List<Entity299> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity299>): Map<String, List<Entity299>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity299): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity299")
class Controller299(private val service: Service299) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity299) = service.save(entity)
    @DeleteMapping("/{id}")
