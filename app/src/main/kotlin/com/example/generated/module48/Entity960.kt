...
interface Entity960Repository : org.springframework.data.jpa.repository.JpaRepository<Entity960, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity960>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity960>
}
...
class Service960(private val repo: Entity960Repository) {
    ...
    fun findActive(): List<Entity960> = repo.findByField4(true)
    fun search(query: String): List<Entity960> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity960>): Map<String, List<Entity960>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity960): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity960")
class Controller960(private val service: Service960) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity960) = service.save(entity)
    @DeleteMapping("/{id}")
