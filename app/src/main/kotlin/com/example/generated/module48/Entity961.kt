...
interface Entity961Repository : org.springframework.data.jpa.repository.JpaRepository<Entity961, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity961>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity961>
}
...
class Service961(private val repo: Entity961Repository) {
    ...
    fun findActive(): List<Entity961> = repo.findByField4(true)
    fun search(query: String): List<Entity961> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity961>): Map<String, List<Entity961>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity961): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity961")
class Controller961(private val service: Service961) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity961) = service.save(entity)
    @DeleteMapping("/{id}")
