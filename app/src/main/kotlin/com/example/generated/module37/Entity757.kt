...
interface Entity757Repository : org.springframework.data.jpa.repository.JpaRepository<Entity757, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity757>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity757>
}
...
class Service757(private val repo: Entity757Repository) {
    ...
    fun findActive(): List<Entity757> = repo.findByField4(true)
    fun search(query: String): List<Entity757> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity757>): Map<String, List<Entity757>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity757): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity757")
class Controller757(private val service: Service757) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity757) = service.save(entity)
    @DeleteMapping("/{id}")
