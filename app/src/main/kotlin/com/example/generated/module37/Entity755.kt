...
interface Entity755Repository : org.springframework.data.jpa.repository.JpaRepository<Entity755, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity755>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity755>
}
...
class Service755(private val repo: Entity755Repository) {
    ...
    fun findActive(): List<Entity755> = repo.findByField4(true)
    fun search(query: String): List<Entity755> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity755>): Map<String, List<Entity755>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity755): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity755")
class Controller755(private val service: Service755) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity755) = service.save(entity)
    @DeleteMapping("/{id}")
