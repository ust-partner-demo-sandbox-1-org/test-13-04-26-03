...
interface Entity744Repository : org.springframework.data.jpa.repository.JpaRepository<Entity744, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity744>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity744>
}
...
class Service744(private val repo: Entity744Repository) {
    ...
    fun findActive(): List<Entity744> = repo.findByField4(true)
    fun search(query: String): List<Entity744> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity744>): Map<String, List<Entity744>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity744): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity744")
class Controller744(private val service: Service744) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity744) = service.save(entity)
    @DeleteMapping("/{id}")
