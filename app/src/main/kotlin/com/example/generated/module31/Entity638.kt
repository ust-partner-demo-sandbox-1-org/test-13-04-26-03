...
interface Entity638Repository : org.springframework.data.jpa.repository.JpaRepository<Entity638, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity638>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity638>
}
...
class Service638(private val repo: Entity638Repository) {
    ...
    fun findActive(): List<Entity638> = repo.findByField4(true)
    fun search(query: String): List<Entity638> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity638>): Map<String, List<Entity638>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity638): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity638")
class Controller638(private val service: Service638) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity638) = service.save(entity)
    @DeleteMapping("/{id}")
