...
interface Entity580Repository : org.springframework.data.jpa.repository.JpaRepository<Entity580, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity580>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity580>
}
...
class Service580(private val repo: Entity580Repository) {
    ...
    fun findActive(): List<Entity580> = repo.findByField4(true)
    fun search(query: String): List<Entity580> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity580>): Map<String, List<Entity580>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity580): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity580")
class Controller580(private val service: Service580) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity580) = service.save(entity)
    @DeleteMapping("/{id}")
