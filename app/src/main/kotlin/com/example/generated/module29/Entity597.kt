...
interface Entity597Repository : org.springframework.data.jpa.repository.JpaRepository<Entity597, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity597>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity597>
}
...
class Service597(private val repo: Entity597Repository) {
    ...
    fun findActive(): List<Entity597> = repo.findByField4(true)
    fun search(query: String): List<Entity597> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity597>): Map<String, List<Entity597>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity597): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity597")
class Controller597(private val service: Service597) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity597) = service.save(entity)
    @DeleteMapping("/{id}")
