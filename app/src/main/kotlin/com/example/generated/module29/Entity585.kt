...
interface Entity585Repository : org.springframework.data.jpa.repository.JpaRepository<Entity585, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity585>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity585>
}
...
class Service585(private val repo: Entity585Repository) {
    ...
    fun findActive(): List<Entity585> = repo.findByField4(true)
    fun search(query: String): List<Entity585> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity585>): Map<String, List<Entity585>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity585): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity585")
class Controller585(private val service: Service585) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity585) = service.save(entity)
    @DeleteMapping("/{id}")
