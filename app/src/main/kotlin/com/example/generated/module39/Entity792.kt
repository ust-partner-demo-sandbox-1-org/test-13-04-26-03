...
interface Entity792Repository : org.springframework.data.jpa.repository.JpaRepository<Entity792, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity792>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity792>
}
...
class Service792(private val repo: Entity792Repository) {
    ...
    fun findActive(): List<Entity792> = repo.findByField4(true)
    fun search(query: String): List<Entity792> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity792>): Map<String, List<Entity792>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity792): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity792")
class Controller792(private val service: Service792) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity792) = service.save(entity)
    @DeleteMapping("/{id}")
