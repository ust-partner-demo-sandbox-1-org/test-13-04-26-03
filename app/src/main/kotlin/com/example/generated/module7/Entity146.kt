...
interface Entity146Repository : org.springframework.data.jpa.repository.JpaRepository<Entity146, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity146>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity146>
}
...
class Service146(private val repo: Entity146Repository) {
    ...
    fun findActive(): List<Entity146> = repo.findByField4(true)
    fun search(query: String): List<Entity146> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity146>): Map<String, List<Entity146>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity146): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity146")
class Controller146(private val service: Service146) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity146) = service.save(entity)
    @DeleteMapping("/{id}")
