...
interface Entity157Repository : org.springframework.data.jpa.repository.JpaRepository<Entity157, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity157>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity157>
}
...
class Service157(private val repo: Entity157Repository) {
    ...
    fun findActive(): List<Entity157> = repo.findByField4(true)
    fun search(query: String): List<Entity157> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity157>): Map<String, List<Entity157>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity157): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity157")
class Controller157(private val service: Service157) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity157) = service.save(entity)
    @DeleteMapping("/{id}")
