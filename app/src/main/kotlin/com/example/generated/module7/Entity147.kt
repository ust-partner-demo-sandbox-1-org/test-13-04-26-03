...
interface Entity147Repository : org.springframework.data.jpa.repository.JpaRepository<Entity147, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity147>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity147>
}
...
class Service147(private val repo: Entity147Repository) {
    ...
    fun findActive(): List<Entity147> = repo.findByField4(true)
    fun search(query: String): List<Entity147> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity147>): Map<String, List<Entity147>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity147): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity147")
class Controller147(private val service: Service147) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity147) = service.save(entity)
    @DeleteMapping("/{id}")
