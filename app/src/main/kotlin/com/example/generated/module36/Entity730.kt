...
interface Entity730Repository : org.springframework.data.jpa.repository.JpaRepository<Entity730, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity730>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity730>
}
...
class Service730(private val repo: Entity730Repository) {
    ...
    fun findActive(): List<Entity730> = repo.findByField4(true)
    fun search(query: String): List<Entity730> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity730>): Map<String, List<Entity730>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity730): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity730")
class Controller730(private val service: Service730) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity730) = service.save(entity)
    @DeleteMapping("/{id}")
