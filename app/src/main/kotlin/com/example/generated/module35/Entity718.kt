...
interface Entity718Repository : org.springframework.data.jpa.repository.JpaRepository<Entity718, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity718>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity718>
}
...
class Service718(private val repo: Entity718Repository) {
    ...
    fun findActive(): List<Entity718> = repo.findByField4(true)
    fun search(query: String): List<Entity718> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity718>): Map<String, List<Entity718>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity718): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity718")
class Controller718(private val service: Service718) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity718) = service.save(entity)
    @DeleteMapping("/{id}")
