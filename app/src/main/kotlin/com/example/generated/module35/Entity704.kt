...
interface Entity704Repository : org.springframework.data.jpa.repository.JpaRepository<Entity704, Long> {
    ...
    fun findByField4(active: Boolean): List<Entity704>
    fun findByField1ContainingIgnoreCase(search: String): List<Entity704>
}
...
class Service704(private val repo: Entity704Repository) {
    ...
    fun findActive(): List<Entity704> = repo.findByField4(true)
    fun search(query: String): List<Entity704> = repo.findByField1ContainingIgnoreCase(query)
    ...
    fun transform(items: List<Entity704>): Map<String, List<Entity704>> {
        return items.groupBy { it.field1 }
            .mapValues { (_, v) -> v.sortedByDescending { it.field8 } }
    }
    fun validate(entity: Entity704): Boolean {
        return entity.field1.isNotBlank() && entity.field3 >= 0 && entity.field6 > 0.0
    }
}

@RestController
@RequestMapping("/api/v1/entity704")
class Controller704(private val service: Service704) {
    @GetMapping
    ...
    @PostMapping
    fun create(@RequestBody entity: Entity704) = service.save(entity)
    @DeleteMapping("/{id}")
